...
<li class='<?php echo $main_class ?>'>
	<span class='left'>
		<input type='text' id='text_<?php echo $filter_slider_id . $unique ?>_1' value='<?php echo $slider_value1?>'/><span class="measure">мм</span>
	</span>
	<span class='right'>
		<input type='text' id='text_<?php echo $filter_slider_id . $unique ?>_2' value='<?php echo $slider_value2?>'/><span class="measure">мм</span>
	</span>
